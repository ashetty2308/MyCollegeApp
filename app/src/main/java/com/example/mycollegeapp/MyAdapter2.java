...
public class MyAdapter2 extends RecyclerView.Adapter<MyAdapter2.ViewHolder> {
    private ArrayList<AssignmentsItem> assignmentsList;
    ...
    public MyAdapter2(ArrayList<AssignmentsItem> assignmentsList) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        AssignmentsItem curr = assignmentsList.get(position);
